    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-100 dark:bg-gray-900">
      <Card className="w-full max-w-md p-6 sm:p-8 bg-white dark:bg-gray-800 shadow-xl rounded-lg">
        ...
        <CardContent className="space-y-6">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white font-semibold py-2 rounded-md transition-colors duration-200" disabled={loading}>
                {loading ? (
                  <>
        ...
        <CardFooter className="text-center text-sm text-gray-600 dark:text-gray-400 justify-center">
          ...
          <Link href="/auth/signup" className="text-blue-600 hover:underline ml-1">Sign Up</Link>
        </CardFooter>
      </Card>
    </div>
  );
