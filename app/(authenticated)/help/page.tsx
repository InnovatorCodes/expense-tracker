...
const faqData = [
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          You can quickly add a new transaction or budget directly from the
          Dashboard.
        </p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            Locate the floating action button, typically in the bottom right
            corner.
          </li>
          <li>
  ...
  },
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          The Dashboard is your central hub for a quick overview of your
          financial health, including:
        </p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <strong>Monthly Summary:</strong> A clear view of your total income
            and expenses for the current month.
          </li>
          <li>
            <strong>Pinned Budget:</strong> Any budget you{"'"}ve pinned for
            close tracking is displayed here.
          </li>
          <li>
            <strong>Recent Transactions:</strong> A list of your most recent
            financial activities.
          </li>
          <li>
            <strong>Monthly Spending Chart:</strong> A pie chart visualizing
            your spending by category for the current month.
          </li>
          <li>
            <strong>Weekly Activity Chart:</strong> A bar chart showing your
            income vs. expense for each day of the past week.
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    answer: (
      <p>
        You can add transactions from the Transactions page. Click the{" "}
  ...
  },
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          From the Transactions page, you can manage all your entries.
        </p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
  ...
  },
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          All budget management is done on the Budgets page.
        </p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <strong>Add Budget:</strong> Click the{" "}
            <strong className="font-semibold">
              {"'"}+{"'"}
            </strong>{" "}
            button on the Budgets page to create a new one.
          </li>
          <li>
            <strong>Edit or Delete Budget:</strong> Head over to the Budgets
            page. You can click the {"'"}Edit{"'"} Icon or the {"'"}Delete{"'"}{" "}
            Icon in the budget.
          </li>
        </ul>
      </>
  ...
  },
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          To keep an important budget in focus, you can pin it to your
          Dashboard.
        </p>
        <ol className="list-decimal space-y-2 pl-5">
          ...
          <li>
            ...
            next to the budget. The icon will change to indicate it{"'"}s
            pinned.
          </li>
          <li>
  ...
  },
  {
    ...
    answer: (
      <p>
        You can customize the app{"'"}s appearance by clicking the{" "}
        <strong>theme button</strong> (a sun or moon icon) located in the top
